...
<head>
    ...
    <title>Dettagli Ricetta - SapurEat</title>
    <link rel="stylesheet" href="assets/global.css">
    <link rel="stylesheet" href="assets/css/dettagli_ricetta.css">
...
<main>
    ...
    <section id="title">
        ...
        <!--<div class="photo" style="background-image: url('<*?php echo immagine_banner($_GET['id']); ?>');">-->
    ...
    <section id="reviews-section">
        ...
        <?php if (isset($_SESSION['loggedin']) && utente_ricetta($_GET['id'],$_SESSION['username'])) {
            ...
            echo '</strong >
            <div id = "recensione" >
                <textarea id = "review-content" name = "descrizione-recensione" placeholder = "La tua recensione" required maxlength="245" autocomplete="off"></textarea >
...
<script src="assets/js/dettagli_ricetta/dettagli_ricetta.js"></script>
<script src="assets/js/dettagli_ricetta/ajax_invio_recensione.js"></script>
